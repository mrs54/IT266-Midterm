 ...
 //DONT DROP ANYTHING FOR NOW
	...
	if( spawnArgs.GetFloat( "no_drops" ) >= 1.0 ){
		...
		if( rVal < 25 ){	// Half of guys drop nothing?
			...
			spawnArgs.Set("def_dropsItem2", "weapon_shotgun");
			spawnArgs.Set("def_dropsItem3", "weapon_rocketlauncher");
			spawnArgs.Set("def_dropsItem4", "weapon_railgun");
			spawnArgs.Set("def_dropsItem5", "weapon_nailgun");
			spawnArgs.Set("def_dropsItem6", "weapon_lightninggun");
